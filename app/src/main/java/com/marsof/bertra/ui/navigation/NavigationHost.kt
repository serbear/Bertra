...
import com.marsof.bertra.ui.screens.ExercisesApiScreenDestination
...
import com.marsof.bertra.ui.screens.SettingsScreen
import com.marsof.bertra.ui.screens.SettingsScreenDestination
...
val sideMenuDestinations = listOf(
    ...
    DividerMenuItem,
    DestinationMenuItem(ExercisesApiScreenDestination),
)
...
//                }
        ...
        composable(route = ExercisesApiScreenDestination.route) {
            ExercisesApiScreen(
                openDrawer = { scope.launch { drawerState.open() } },
            )
        }
