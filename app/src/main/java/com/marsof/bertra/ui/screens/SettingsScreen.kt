    ...
    Row(
        ...
        Slider(
            ...
            colors = SliderDefaults.colors(
                thumbColor = LocalCustomColors.current.primary,
                activeTrackColor = LocalCustomColors.current.secondary,
                inactiveTrackColor = LocalCustomColors.current.tertiary,
                activeTickColor = LocalCustomColors.current.secondary,
                inactiveTickColor = LocalCustomColors.current.secondary,
            ),
            modifier = Modifier.weight(1f),
        )
        Text(
            text = "$sliderPositionText",
    ...
    Row(
        ...
        Switch(
            ...
            colors = SwitchDefaults.colors(
                checkedThumbColor = LocalCustomColors.current.primary,
                checkedTrackColor = LocalCustomColors.current.tertiary,
                checkedBorderColor = LocalCustomColors.current.primary,
                uncheckedThumbColor = LocalCustomColors.current.primary,
                uncheckedTrackColor = LocalCustomColors.current.tertiary,
            ),
        )
    }
}